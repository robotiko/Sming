...
public:
    ...
    const int8_t getCurrentChannel()
    {
    ...
    const bool isEndOfCycle()
    {
        return (_currentChannel == -1);
    }

    const ServoTimerSequence timerId()
    {
